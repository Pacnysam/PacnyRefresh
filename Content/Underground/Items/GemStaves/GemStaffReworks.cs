...
namespace PacnyRefresh.Content.Underground.Items.GemStaves
{
    public class GemStaffSystem : ModSystem
    {
        public override void PostSetupContent()
        {
            ...
            {
                TextureAssets.Item[item] = Request<Texture2D>($"PacnyRefresh/Content/Underground/Items/GemStaves/{ItemID.Search.GetName(item)}");
            }
        }
    ...
    public class GemStaffReworkItem : GlobalItem
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            {
                ItemSets.Glowmask[item] = (Request<Texture2D>($"PacnyRefresh/Content/Underground/Items/GemStaves/{ItemID.Search.GetName(item)}Glow", AssetRequestMode.ImmediateLoad), Color.White with { A = 160 }, true);
            }
        }
        ...
        public override bool Shoot(Item item, Player player, EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 velocity, int type, int damage, float knockback)
        {
            ...
            {
                Projectile projectile = Projectile.NewProjectileDirect(source, position, velocity.RotatedBy(MathHelper.ToRadians(Main.rand.Next(-9, 9))) * 0.85f, type, (int)(damage * 0.75f), knockback, player.whoAmI);
            ...
            if (item.type == ItemID.AmberStaff)
            {
                ...
                Projectile projectile = Projectile.NewProjectileDirect(source, position, velocity, type, damage, knockback, player.whoAmI, Main.rand.NextFloat(-3, 3));
    ...
    public class GemStaffReworkProjectile : GlobalProjectile
    {
        ...
        public override void SetStaticDefaults()
        {
            ProjectileID.Sets.CultistIsResistantTo[ProjectileID.AmberBolt] = true;
        }
        ...
        public override bool PreAI(Projectile projectile)
        {
            ...
            switch (projectile.type)
            {
                ...
                case ProjectileID.DiamondBolt:
                    {
                        ParticleOrchestrator.RequestParticleSpawn(clientOnly: true, ParticleOrchestraType.ChlorophyteLeafCrystalShot,
                        ...
                        {
                            Dust dust = Dust.NewDustDirect(projectile.position, projectile.width, projectile.height, DustType<LightDustFast>(), 0, 0, 0, Color.White, Main.rand.NextFloat(0.3f, 0.65f));
                            //Dust dust = Dust.NewDustPerfect(projectile.Center, DustType<LightDustFast>(), Vector2.Zero, 0, Color.White, Main.rand.NextFloat(0.3f, 0.65f));
    ...
    {
        public override string Texture => "PacnyRefresh/Assets/Textures/Empty";
        ...
        {
            Texture2D tex = Request<Texture2D>("PacnyRefresh/Assets/Textures/Flares/wavering").Value;
