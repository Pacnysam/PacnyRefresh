...
namespace PacnyRefresh.Content.Dungeon.Items.BlueMoon
{
    ...
    public class BlueMoonP : BaseFlailProjectile 
    {
        ...
        public override void Load()
        {
            glowTex = Request<Texture2D>("PacnyRefresh/Content/Dungeon/Items/BlueMoon/BlueMoonPGlow");
        }
        ...
        public override void ThrowEffect(Player player)
        {
            ...
            {
                SoundEngine.PlaySound(new SoundStyle("PacnyRefresh/Assets/Sounds/Dash") { Pitch = -0.4f, PitchVariance = 0.4f }, Projectile.position);
            }
        }
    ...
    public class BlueMoonSystem : ModSystem 
    {
        ...
        {
            TextureAssets.Item[ItemID.BlueMoon] = Request<Texture2D>("PacnyRefresh/Content/Dungeon/Items/BlueMoon/BlueMoon");
        }
