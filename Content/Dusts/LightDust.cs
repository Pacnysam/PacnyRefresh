...
namespace PacnyRefresh.Content.Dusts
{
    public class LightDust : ModDust
    {
        ...
        public override bool PreDraw(Dust dust)
        {
            ...
            //Main.spriteBatch.Draw(Request<Texture2D>("PacnyRefresh/Content/Dusts/LightDust").Value, dust.position - Main.screenPosition, dust.frame, dust.color * dust.alpha, GoldLeafWorld.rottime * 2, new Vector2(0, 0), dust.scale * 1.5f, SpriteEffects.None, 0);
            //Main.spriteBatch.Draw(Request<Texture2D>("PacnyRefresh/Content/Dusts/LightDust").Value, dust.position - Main.screenPosition, dust.frame, dust.color * dust.alpha, GoldLeafWorld.rottime * -2, new Vector2(0, 0), dust.scale * 1.5f, SpriteEffects.None, 0);
            return false;
        }
    }
    ...
    {
        public override string Texture => "PacnyRefresh/Content/Dusts/LightDust";
